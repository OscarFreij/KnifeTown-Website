<div class="container">
    ...
    <div class="row">
        ...
        <form class="container" method="POST">
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Mejladress (Krävs)</label>
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-success mb-3 col-12">Skicka meddelande!</button>
            </div>
    </form>
    </div>
</div>